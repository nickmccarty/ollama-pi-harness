...
SYNTH_INSTRUCTION = (
    "Output ONLY the markdown starting with #. For each section, include a detailed 'How' subsection with a concrete code example, configuration snippet, or step-by-step implementation that demonstrates how to apply the technique in practice. Name specific tools, libraries, and versions (e.g., Weaviate v1.22, Redis 7.0). Ensure all sections contain at least one working code example or configuration block to improve specificity and depth."
)
# AUTORESEARCH:SYNTH_INSTRUCTION:END

# AUTORESEARCH:SYNTH_INSTRUCTION_COUNT:BEGIN
SYNTH_INSTRUCTION_COUNT = (
    "Output ONLY the markdown starting with #. For each of the 5 sections, include a detailed 'How' subsection with a concrete code example, configuration snippet, or step-by-step implementation that demonstrates how to apply the technique in practice. Name specific tools, libraries, and versions (e.g., Weaviate v1.22, Redis 7.0). Ensure all sections contain at least one working code example or configuration block to improve specificity and depth."
)
